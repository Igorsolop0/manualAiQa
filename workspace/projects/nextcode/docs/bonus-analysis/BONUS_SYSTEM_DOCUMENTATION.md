...
## РОЗДІЛ 5: АКТУАЛЬНА АРХІТЕКТУРА БОНУСНОЇ СИСТЕМИ (2026-03-12)

**Джерело:** Бонус менеджер Minebit (розмова з Ihor), 2026-03-12.

### ⚠️ Важлива зміна в архітектурі

**Сегменти BO НЕ використовуються для бонусів VIP та рівнів!**

### Як працює бонусна система зараз

| Компонент | Використання |
|-----------|--------------|
| **BackOffice сегменти** | ❌ НЕ використовуються для VIP/рівнів |
| **Smartico тригери** | ✅ Всі бонуси для VIP, рівнів, тощо видаються через Smartico |
| **Smartico CRM** | Повністю керує бонусами: розрахунок, тригери, видача |

### Що треба тестувати (Фокус)

**Тільки ці кейси:**

| Кейс | Опис |
|------|------|
| **Sign up bonus** | Бонус при реєстрації |
| **Promocode + Smartico** | Введення промокоду → видача бонусу через Smartico |

### Таймер бонусу — Важлива логіка

**Правило:** Коли бонус видається, таймер стартує **заново** для кожного нового юзера.

**Приклад:**
- **Активація:** 2 дні на активацію бонусу
- **Відігравання:** 1 день на відігравання

**Кожен новий юзер отримує свіжий таймер:**
- Юзер A отримав бонус → таймер: 2 дні (активація) + 1 день (відігравання)
- Юзер B отримав бонус → таймер: 2 дні (активація) + 1 день (відігравання)
- Обидва мають однаковий час з моменту видачі

### Шаблон бонусу

**Важливо:** Шаблон бонусу **НЕ видаляється** після видачі бонусу гравцю.

- Шаблон залишається в системі
- Можна видавати бонус багатьом гравцям
- Кожен гравець отримує свій екземпляр бонусу з власним таймером

### Висновок для тестування

**ДО:**
- ✅ Фокус на Smartico тригерах
- ✅ Тестувати Sign up bonus
- ✅ Тестувати Promocode → Smartico flow
- ✅ Перевіряти таймери (активація + відігравання)
- ✅ Перевіряти що шаблон залишається

**НЕ треба:**
- ❌ Тестувати BO сегменти для VIP/рівнів (не використовуються)
- ❌ Шукати логіку бонусів в BO (вона в Smartico)
