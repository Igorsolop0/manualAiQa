#!/usr/bin/env python3
"""
Check Jira for PandaSen tickets in Ready for Testing or On Production states.
"""
...
def check_pandasen_tickets(config):
    ...
    jql = 'project = "PandaSen" AND (status = "Ready for Testing" OR status = "On Production")'
...
def main():
    """Main function."""
    print("🎫 Jira Watcher - PandaSen Project Check")
    print("=" * 50)
